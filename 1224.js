/* 공지말 */
var g_port = 1224
var g_notice = '/img https://lolwiki.xyz/static/1.png'
...
async function lol_get_user_info(android_id)
{
	...
	var lol_user_memos = await db_select('UserMemos', 'LoLWikiMemos', `android_id LIKE "${android_id}"`, 'LIMIT 1')
	console.log(lol_user_memos)

	ret.memos = lol_user_memos
	if(!lol_user_memos)
	{
