...
io.sockets.on('connection', function(socket) 
{
	...
	socket.on('lol_get_article_list', async function(data) {
		...
		var ret = await lol_get_article_list(android_id, seq, cnt, body, nick, vote, mine, viewer_android_id)
	...
	socket.on('lol_write', async function(data) {
		...
		try
		{
			await lol_write(android_id, subject, body, youtube_url, image, false, data.account_id, data.password)
		}
		catch(error)
		{
...
lol_get_article_list = function(android_id, seq, cnt, body, nick, vote, mine, viewer_android_id) {
	return lolwikiApiClient.getArticleList(null, android_id, seq, cnt, body, nick, vote, mine, viewer_android_id)
}
