...
async function lol_write_image_clear_text()
{
	...
	// try {
	// 	var clipboard_data = await navigator.clipboard.read()
	// 	var blob = clipboard_data[0].getType('image/png')
	// 	var reader = new FileReader()
	// 	reader.onload = function(ev) { 
	// 		var ret = ev.target.result
	// 		g_lol_write_image_data = ret
	...
	// catch(exception)
	// {
	// 	console.log('클립보드의 내용이 이미지가 아니다..', exception)
	// }
}
